...
class SurveyCategoryImport implements ToCollection, WithStartRow
{
    /**
    ...
    */
    public function collection(Collection $collection)
    {
        ...
        if (empty($row[1]) || strtoupper($row[1]) != strtoupper('Kategori Pernyataan')) {
        ...
        foreach ($collection as $rw => $row) 
        {
            ...
            if (!empty($name)) {
                // Simpan Data
                SurveyCategory::firstOrCreate(['name' => $name]);
            }
        }
