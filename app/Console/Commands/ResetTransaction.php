...
class ResetTransaction extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            if ($this->confirm('Semua data Transaksional akan dihapus, Lanjutkan ?')) {
                // DB::beginTransaction();
                ...
                DB::table('trans_fees_auditor_data_document')->truncate();
                ...
                DB::table('trans_followup_regs_users')->truncate();
